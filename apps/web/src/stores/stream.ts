...
export type StreamStatus = "idle" | "connecting" | "streaming" | "stopping" | "error";
...
export const useStreamStore = create<StreamState>()(
  devtools(
    (set) => ({
      ...
      appendContent: (chunk) =>
        set((state) => ({ content: state.content + chunk }), false, "stream/content"),

      appendReasoning: (chunk) =>
        set((state) => ({ reasoning: state.reasoning + chunk }), false, "stream/reasoning"),
