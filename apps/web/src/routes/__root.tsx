...
export const Route = createRootRoute({
  head: () => ({
    meta: [
      ...
      { property: "og:url", content: "https://osschat.dev" },
      { property: "og:image", content: "https://osschat.dev/og-image.png" },
      ...
      { name: "twitter:image", content: "https://osschat.dev/og-image.png" },
    ],
    links: [
