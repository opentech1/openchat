...
// Logo component
function Logo({ className, size = 'default' }: { className?: string; size?: 'small' | 'default' | 'large' }) {
  const sizeClasses = {
    ...
    <div className="grid min-h-svh lg:grid-cols-2">
      ...
      <div className="flex flex-col gap-4 p-6 md:p-10">
        <div className="flex justify-center gap-2 md:justify-start">
          <Link to="/" className="flex items-center gap-2 font-medium transition-opacity hover:opacity-80">
            <Logo size="small" />
          </Link>
        </div>
